...
class OfficeHoursViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    fun bind(item: OfficeHoursItem) {
        ...
        if (item.reception1 != receptionStr) date1.setTextColor(Color.BLACK)
        if (item.reception2 != receptionStr) date2.setTextColor(Color.BLACK)
        if (item.reception3 != receptionStr) date3.setTextColor(Color.BLACK)
        if (item.reception4 != receptionStr) date4.setTextColor(Color.BLACK)
        if (item.reception5 != receptionStr) date5.setTextColor(Color.BLACK)
        if (item.reception6 != receptionStr) date6.setTextColor(Color.BLACK)
